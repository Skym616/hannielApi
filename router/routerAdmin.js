...
router.route('/all/campaign/:idPharmacy').get(auth, ctrlAdmin.getCampaignByHospital);
...
router.route('/all/medicament/:idPharmacy').get(auth, ctrlAdmin.getMedicamentByPharmacy);
...
router.route('/c/hospital').post(auth, multer, ctrlAdmin.createHospital);
